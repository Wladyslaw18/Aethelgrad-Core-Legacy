// Aethelgrad Core Legacy - Permission Helper
// Standardized permission checking for public release
// This helper maintains the existing tag-based system while providing consistent interface

export const PERMISSION_LEVELS = {
    OWNER: ["AE", "aethelgrad:owner"],
    ADMIN: ["admin", "Admin", "AEb_manager"],
