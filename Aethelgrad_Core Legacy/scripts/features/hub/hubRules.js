...
function inHub(loc, cfg) {
    ...
    return dx <= cfg.radius && dz <= cfg.radius;
}
...
export function initHubRules() {
    ...
    system.runInterval(() => {
        ...
        for (const p of world.getPlayers()) {
            ...
            try {
                ...
                p.addEffect("weakness", 80, { amplifier: 255, showParticles: false });
                p.addEffect("regeneration", 80, { amplifier: 255, showParticles: false });
            } catch {}
    ...
    system.beforeEvents.startup.subscribe(({ customCommandRegistry }) => {
        try {
            ...
            // /ae:banitem -> ban item in hand (saved to ae:banned_items)
            customCommandRegistry.registerCommand({
                name: "ae:banitem",
